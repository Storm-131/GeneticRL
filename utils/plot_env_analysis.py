...
def plot_material_accuracies(env, distribution=None, sorting_mode=0):
    ...
    if distribution is None:
        ...
        raise ValueError("The sum of the distribution must equal 1 (100%).")
    ...
    for occ_level in occupation_levels:
        ...
        env.set_occupation_level(occ_level, distribution=distribution)
        env.update_accuracy()
...
def plot_sorting_rewards_vs_purity_deviation(env, num_samples=10):
    ...
    plt.savefig('./img/figures/3_sorting_rewards_vs_purity_deviation.svg')
    plt.savefig('./img/figures/3_sorting_rewards_vs_purity_deviation.png', dpi=300)
    plt.show()
